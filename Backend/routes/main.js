...
const checJWT = require('../middlewares/check-jwt');
const category = require('../models/category');
...
router.get('/product/:id', (req, res, next) => {
 ...
 router.post('/review', checJWT, (req, res, next) => {
    async.waterfall([
      function(callback) {
...
router.post('/payment', checJWT, (req, res, next) => {
    const stripeToken = req.body.stripeToken;
    const currentCharges = Math.round(req.body.totalProducts * 100);
